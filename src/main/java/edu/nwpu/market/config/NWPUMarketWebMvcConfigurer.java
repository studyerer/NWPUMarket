...
import edu.nwpu.market.interceptor.NWPUMarketCartNumberInterceptor;
import edu.nwpu.market.interceptor.NWPUMarketLoginInterceptor;
...
public class NWPUMarketWebMvcConfigurer implements WebMvcConfigurer {
    ...
    @Autowired
    private NWPUMarketLoginInterceptor newBeeMallLoginInterceptor;
    @Autowired
    private NWPUMarketCartNumberInterceptor newBeeMallCartNumberInterceptor;
