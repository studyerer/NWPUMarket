...
public class NWPUMarketUserServiceImpl implements NWPUMarketUserService {
    ...
    public PageResult getNewBeeMallUsersPage(PageQueryUtil pageUtil) {
        List<NWPUMarketUser> mallUsers = mallUserMapper.findMallUserList(pageUtil);
    ...
    @Override
    public NWPUMarketUserVO updateUserInfo(NWPUMarketUser mallUser, HttpSession httpSession) {
        NWPUMarketUser user = mallUserMapper.selectByPrimaryKey(mallUser.getUserId());
        if (user != null) {
